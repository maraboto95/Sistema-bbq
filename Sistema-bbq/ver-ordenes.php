...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    $query = "SELECT * FROM ordenes WHERE estatus='pendiente'";
        ...
        <section id="about" class="about">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td style="font-size:18px;"><strong><?php echo $row['nodeorden']; ?></strong></td>
                            <td style="font-size:18px;"><strong><?php echo $row['cliente']; ?></strong></td>
                            <td style="font-size:18px;"><strong><?php echo $row['direccion']; ?></strong></td>
                            <td style="font-size:18px;"><strong><?php echo $row['fecha']; ?></strong></td>
                            <td style="font-size:18px;"><strong><?php echo $row['hora']; ?></strong></td>
                            <td style="font-size:18px;"><strong>$<?php echo $row['total']; ?></strong></td>
                            <td style="font-size:18px;"><strong><?php echo $row['notas']; ?></strong></td>
                            <td style="font-size:18px;"><strong><?php echo $row['estatus']; ?></strong></td>
                            <td>
                                <a href="entregar.php?id=<?php echo $row['nodeorden']; ?>" class="btn btn-success" role="button">Marcar como entregada</a>
                            </td>
                            <td>
                                <a href="cancelar.php?id=<?php echo $row['nodeorden']; ?>" class="btn btn-success" role="button">Borrar</a>
                            </td>
                        </tr>
                        <?php
                    }
