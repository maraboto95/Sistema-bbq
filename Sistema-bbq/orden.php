...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    $query = "SELECT * FROM detalledeorden WHERE id='$orden'";
        ...
        <section id="about" class="about">
                <div class="container">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td style="font-size:18px;"><?php echo $row['producto']; ?></td>
                            <td style="font-size:18px;"><?php echo $row['precio']; ?></td>
                            <td>
                                <a href="borrar-producto-orden.php?id=<?php echo $row['producto']; ?>" class="btn btn-success" role="button">Borrar</a>
                            </td>
                        </tr>
                        <?php
                    }
    ...
    $result = mysqli_query($conn, $query);
                        ...
                        ?>
                                            <center>
                                            <a href="agregar-a-orden.php?id=<?php echo $row['id']; ?>" class="btn btn-success" role="button"><?php echo $row['nombre']; ?> <?php echo $row['precio']; ?></a>
                                                     <?php
                    }

                        mysqli_close($conn);
                        ?>
                                            <br><br><br><br><a href="confirmar-orden.php" class="btn btn_news_color" role="button">Confirmar Orden</a>
                                        </center>
                                        </div>
                                    </div>
                                </div>
