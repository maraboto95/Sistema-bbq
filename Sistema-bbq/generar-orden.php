...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    if($busqueda != null){
        $query = "SELECT * FROM clientes WHERE telefono='$busqueda'";
    }else{
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <section id="about" class="about">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th style="font-size:20px;">Teléfono</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:18px;"><?php echo $row['apellido']; ?></td>
                            <td style="font-size:18px;"><?php echo $row['direccion']; ?></td>
                            <td style="font-size:18px;"><?php echo $row['telefono']; ?></td>
                            <td>
                                <a href="crear-orden.php?id=<?php echo $row['id']; ?>" class="btn btn-success" role="button">Ordenar</a>
                ...
                <a href="registrar-cliente.php" class="btn btn-success" role="button">Nuevo Cliente</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
