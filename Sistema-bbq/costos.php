...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    $query = "SELECT * FROM costos WHERE fecha='$date'";
                        ...
                        <div class="main_about_area sections">
                            <div class="col-sm-10 col-sm-offset-1">
                                ...
                                <div class="main_about_content">
                                    <div class="row">
                                        <div class="col-sm-6 wow fadeInRight" data-wow-duration="700ms">
                                            <div class="single_about_right_content">
                                                <center>
                                                <h2>Registrar Costo</h2><br>
        <form role="form" action="agregar-costo.php" method="post">
            ...
            <button type="submit" class="btn bg-success btn-block">Registrar</button>
            <!-- FIN DE LA FORMA -->
        </form>
                                            </center>
                                            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td style="font-size:18px;"><strong><?php echo $row['producto']; ?></strong></td>
                            <td style="font-size:18px;"><strong>$<?php echo $row['precio']; ?></strong></td>
                            <td style="font-size:18px;"><center><strong><?php echo $row['fecha']; ?></strong></center></td>
                            <td>
                                <a href="borrar-costo.php?id=<?php echo $row['id']; ?>" class="btn btn-success" role="button">Borrar</a>
                            </td>
                        </tr>
                        <?php
                    }
                ...
                <h2>TOTAL DE COSTO: $<?php echo $total; ?></h2>
                                </div>
                            </div>
                        </div>
                        </div>
