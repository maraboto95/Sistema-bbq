...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <section id="about" class="about">
            ...
            <h3>Notas:</h3>
            <form role="form" action="confirmar.php" method="post">
            <textarea name="notas" class="form-control" rows="5" style="color:#000000;"></textarea><br><br><br>
            <button type="submit" class="btn btn_news_color" role="button">Confirmar</button>
        </form>
        </center>
                                        </div>
                                    </div>
